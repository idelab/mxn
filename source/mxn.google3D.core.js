...
Mapstraction: {
	...
	init: function(element, api) {		
		...
		this.maps[api] = null;
		  ...
		  google.earth.createInstance(element, function initCallback(object) {
		  me.maps[api] = object;
		  me.maps[api].getWindow().setVisibility(true);
		  initMap();
		}, function failureCallback(object) {
			alert('failure creatin map');
		});
		
		
		
		/*function initCallback(object) {
		  this.maps[api] = object;
		  this.maps[api].getWindow().setVisibility(true);
		  procesarKML();
		}
		function failureCallback(object) {
			alert('failure creatin map');
